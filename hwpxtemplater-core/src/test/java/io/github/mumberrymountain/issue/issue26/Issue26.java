package io.github.mumberrymountain.issue.issue26;
...
import io.github.mumberrymountain.util.TableFilter;
import io.github.mumberrymountain.util.TestUtil;
...
public class Issue26 {
    @Test
    @DisplayName("1. 태그 구분 문자가 전각 문자일 때 기본 단락 조건문 템플릿 렌더링")
    public void conditionParaTextTest() throws Exception {

        HWPXTemplater hwpxTemplater = HWPXTemplater.builder()
                .parse(TestUtil.getFilePath(this.getClass(), "hwpx/issue/26/#26_Condition_Para_Text.hwpx"))
    ...
    @Test
    @DisplayName("2. 태그 구분 문자가 전각 문자일 때 기본 단락 반복문 템플릿 렌더링")
    public void loopParaTextTest() throws Exception {
        ...
        HWPXTemplater hwpxTemplater = HWPXTemplater.builder()
                .parse(TestUtil.getFilePath(this.getClass(), "hwpx/issue/26/#26_Loop_Para_Text.hwpx"))
                .render(new HashMap<String, Object>() {{
    ...
    @Test
    @DisplayName("3. 태그 구분 문자가 전각 문자일 때 기본 단락 PNG 로컬 파일 이미지 렌더링")
    public void imageParaLocalPngImageTest() throws Exception {

        HWPXTemplater hwpxTemplater = HWPXTemplater.builder()
                .parse(TestUtil.getFilePath(this.getClass(), "hwpx/issue/26/#26_Image_Basic_Para.hwpx"))
    ...
    @Test
    @DisplayName("4. 태그 구분 문자가 전각 문자일 때 기본 단락 테이블 기본 렌더링")
    public void tableParaBasicTableTest() throws Exception {
        ...
        HWPXTemplater hwpxTemplater = HWPXTemplater.builder()
                .parse(TestUtil.getFilePath(this.getClass(), "hwpx/issue/26/#26_Table_Basic_Para.hwpx"))
                .render(new HashMap<String, Object>() {{
