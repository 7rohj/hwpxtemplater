package com.github.mumberrymountain.technical.config;
...
import com.github.mumberrymountain.util.ParaTFilter;
import com.github.mumberrymountain.util.TestUtil;
...
public class AutoTrim {
    @Test
    @DisplayName("1. autoTrim Configuration 옵션 적용 - config 문자열로 설정")
    ...
    @Test
    @DisplayName("2. autoTrim Configuration 옵션 적용 - config ConfigOption Enum으로 설정")
    public void configAutoTrimTestConfigOptEnum() throws Exception {
