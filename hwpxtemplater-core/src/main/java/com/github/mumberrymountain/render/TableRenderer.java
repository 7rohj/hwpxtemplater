...
public class TableRenderer {
    ...
    private final com.github.mumberrymountain.model.table.Table table;

    public TableRenderer(HWPXRenderer rootRenderer, com.github.mumberrymountain.model.table.Table table) {
