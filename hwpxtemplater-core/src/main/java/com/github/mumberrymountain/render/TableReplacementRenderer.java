...
import static com.github.mumberrymountain.render.RendererUtil.isCurrentRangeLoop;
...
public class TableReplacementRenderer <H> implements SinglePlaceHolderRenderer{
    ...
    public void renderReplacement(LinkedRunItem linkedRunItem, PlaceHolder placeHolder, Object value) {
        if(isCurrentRangeLoop(rangeStack.current()) && isCurrentRangeProcessing(rangeStack.current())) {
            ...
            if (value == null || !(value instanceof com.github.mumberrymountain.model.table.Table)) {
            ...
            Table table = new TableRenderer(rootRenderer, (com.github.mumberrymountain.model.table.Table) value).render();
