...
public class TableRenderer {
    ...
    private final io.github.mumberrymountain.model.table.Table table;

    public TableRenderer(HWPXRenderer rootRenderer, io.github.mumberrymountain.model.table.Table table) {
